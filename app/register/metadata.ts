...
export async function generateMetadata(
  ...
  // Default metadata
  let title = "Join Quranki - Create your account";
  let description = "Create your Quranki account and start reviewing the Quran with the help of spaced repetition and friends.";
  ...
  return {
    ...
    openGraph: {
      title,
      description,
      url: "https://quranki.com/register",
      siteName: "Quranki",
      type: "website",
      images: [
        {
